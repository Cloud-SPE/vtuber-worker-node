...
- **Wire compatibility with `livepeer-modules-project/payment-daemon`.** This repo owns a local proto/gRPC contract snapshot and must stay byte-compatible with the daemon's wire surface. Drift is a release-blocking bug.
